...
class App extends React.Component {
    ...
    return (
      <div className="p-10 space-y-10">
        <header className="App-header container mx-auto">
          <img src={logo} alt="Logo" width={300} height={300} className="mx-auto" />
          <div className="mx-auto space-y-5">
            ...
            <div className="flex flex-col justify-center items-center text-center">
              <a href="https://github.com/OpenSesameManager/OpenSesame" className="mx-auto bg-blue-500 w-1/3 p-4 rounded-xl shadow-xl font-bold text-gray-50 text-xl">View the source code</a>
            </div>
          </div>
        </header>
  ...
  detailView = (title, description) => {
    return (
      <div className="container mx-auto bg-gray-200 p-4 rounded-xl">
